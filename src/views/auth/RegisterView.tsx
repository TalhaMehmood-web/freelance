  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8">
        ...
        <p className="text-sm text-text-secondary">Join 1 million+ professionals on FreelanceHub</p>
      </div>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-1.5">
          ...
          {form.formState.errors.fullName && (
            <p className="text-xs text-danger-600">{form.formState.errors.fullName.message}</p>
          )}
        </div>
        ...
        <div className="space-y-1.5">
          <div className="flex items-start gap-2.5">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                form.setValue("acceptTerms", checked as true, { shouldValidate: true })
              }
            />
            <Label htmlFor="acceptTerms" className="text-sm text-text-secondary leading-relaxed cursor-pointer font-normal">
              I agree to the{" "}
          ...
          {form.formState.errors.acceptTerms && (
            <p className="text-xs text-danger-600">{form.formState.errors.acceptTerms.message}</p>
          )}
        </div>
