    ...
    <Sheet open={open} onOpenChange={handleOpen}>
      <SheetContent side="right" className="w-full sm:max-w-md flex flex-col p-0 gap-0">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-7">
          ...
          {/* Budget */}
          <div>
            <p className="text-sm font-semibold text-text-primary mb-3">Budget</p>
            <div className="flex items-end gap-3">
              <div className="flex-1">
                <Label htmlFor="sheet-minPrice" className="text-xs text-text-tertiary mb-1.5 block">
                  Min ($)
                </Label>
                <Input
                  id="sheet-minPrice"
              ...
              <div className="flex-1">
                <Label htmlFor="sheet-maxPrice" className="text-xs text-text-tertiary mb-1.5 block">
                  Max ($)
                </Label>
                <Input
                  id="sheet-maxPrice"
          ...
          {/* Delivery Time */}
          <div>
            <p className="text-sm font-semibold text-text-primary mb-3">Delivery Time</p>
            <ChipGroup
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {RATING_OPTIONS.map((opt) => (
                ...
                >
                  {opt.value && <Star className="h-3.5 w-3.5 fill-accent-500 text-accent-500 shrink-0" />}
                  {opt.label}
                </Button>
              ))}
            </div>
